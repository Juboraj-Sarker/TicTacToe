...
import com.juboraj_sarker.tictactoe.activity.GameScreenActivity;
...
public class TicTacToe{
    ...
    protected GameScreenActivity controller;

    public TicTacToe() {
    }

    public void setController(GameScreenActivity controller){this.controller = controller;}
